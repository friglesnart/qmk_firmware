...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_FL1] = LAYOUT(
        ...
        RESET, _______, _______, _______, _______,   _______, _______, _______, KC_PSCR, _______, _______, _______, _______,          _______, KC_INS,
        KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   _______, KC_HOME,
        _______,          KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, _______, _______, _______, _______, _______, _______, _______,          _______, KC_END,
        KC_RCTL, _______, _______,                            _______,                   _______, _______,          _______,          _______, _______),
